...
class Login{
	...
	public void loginView() {
		...
		attendance.setForeground(Color.decode("#FF0000"));
		attendance.setBounds(100, 275, 400, 50);
		attendance.setFont(new Font("Arial", Font.BOLD, 50));
		...
		management.setFont(new Font("Georgia", Font.BOLD, 15));
		...
		username.setForeground(Color.decode("#FF0000"));
